...
class _SignupState extends State<Signup> {
  ...
  Future<void> sendOtp() async {
    ...
    String apiUrl =
        "${AppContants.baseURl}${AppContants.createCustomerNewURL}";
    print('helllooooo${apiUrl}');
    print({
            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  isSHowOTP ?  SizedBox(height: 10,):SizedBox(),
                    ...
                    child: Column(
                      ...
                      children: [
                        DropdownButtonFormField<CityResponse>(
                          ...
                          items: authController.cityResponse.isEmpty
                              ? [
                            const DropdownMenuItem<CityResponse>(
                              enabled: false,
                              child: Center(
                              ...
                              : authController.cityResponse.isEmpty
                              ? [
                            const DropdownMenuItem<CityResponse>(
                              enabled: false,
                              child: Text(
                              ...
                              : authController.cityResponse.map((city) {
